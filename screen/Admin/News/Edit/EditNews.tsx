...
//TODO: Refactor css and component again  with add news container
const EditContentPage: React.FC<Props> = ({ news }) => {
	...
	return (
		<StyledContainer width={width}>
			...
			/>
			<ContentContainer width={width} height={height} news={news} />
		</StyledContainer>
	);
};
