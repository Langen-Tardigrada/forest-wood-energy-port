...
> ![Admin Login](./public/assets/admin-preview/admin-login.png)
> ![News Management](<./public/assets/admin-preview/news-management(hovered-card).png>)
> ![Add News](./public/assets/admin-preview/add-news.png)
